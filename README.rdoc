...
*Your path should include C:\Program Files\Git\bin and C:\Program Files\Git\cmd
...
I also got some great feedback from Xerxes Battiwalla, see his blog post on the matter. http://www.xerxesb.com/2009/getting-cruisecontrolnet-to-talk-to-git/ 
